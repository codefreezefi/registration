...
export const Registration = () => {
  ...
  return (
    <main>
      <div class="container">
        <div class="row">
          <article class="col col-lg-8 offset-lg-2">
            <div class="card">
              <div class="card-header">
                <h1>
                  Codefreeze {Codefreeze.start.getFullYear()} Registration
                </h1>
              </div>
              <div class="card-body">
                <p>
                  ...
                  <a href="mailto:aki@rinkkasatiainen.fi">
                    aki@rinkkasatiainen.fi
                  </a>
                  ) and Markus Tacker (
                ...
                <div class="card-footer">
                  ...
                  <ul>
                    <li>
                      ...
                      <a
                        href="https://codefreeze.fi/#accommodation"
                        target="_blank"
                      >
                        Accommodation
                      </a>
                    ...
                    <li>
                      ...
                      <a
                        href="https://codefreeze.fi/#directions"
                        target="_blank"
                      >
                        Directions
                      </a>
